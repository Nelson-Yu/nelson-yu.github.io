const projectsData = [
  ...
  },
  {
    ...
    role: 'App Architect, Full-Stack Developer',
    description:
      "CDR is a Digital Lab redesign and update of a joint project between Sunny Hill Health Centre at BC Children's Hospital and the BC Ministry of Children and Family Development. The objective is to provide a platform for users to search for resources of their interest regarding to children, youth, and family health. This project is currently in development and is being built with a variation of the MERN stack, substituting ExpressJS with KoaJS, and GraphQL.",
    stack: [
      'mongodb.svg',
      'koa.svg',
      'nodejs.svg',
